...
from ParallelWaveGAN.parallel_wavegan.layers import PQMF, TADEResBlock
from ParallelWaveGAN.parallel_wavegan.models import MelGANDiscriminator as BaseDiscriminator
